...
$query = "SELECT *, p.id AS id, p.url AS url FROM " . $ConfigDB["prefix"] . "price p LEFT JOIN " . $ConfigDB["prefix"] . "shops s ON s.id=p.shop_id WHERE updated_at < NOW() - INTERVAL '1' DAY ORDR BY RAND()";
